...
def upgrade():
    ...
    if table_exists:
        ...
        # Skip ivfflat index creation for small datasets (memory issues)
        # Sequential scan is acceptable for small generic knowledge stores
        print("   ⚠️  Skipping ivfflat index for generic_knowledge (memory limits)")
        print("      Sequential scan will be used (acceptable for small datasets)")
