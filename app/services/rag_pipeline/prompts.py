...
12. **Nearby Amenities/Transport**:
    - For **amenities** (hospitals, schools, libraries, coffee shops, etc.):
      ...
      * If Google Maps links for amenities are provided (they will be passed in separately), you MUST:
        ...
        - **When links are provided, they ARE the answer** — do NOT start with "I don't have specific information" or "the listing data doesn't contain". Lead with the link.
        ...
        - **If the listing data does NOT contain specific amenity information**, say directly: "You can find nearby [amenity type from user's question, e.g. bars / police stations] here: [link(s)]" — use the same wording as the user (e.g. "bars", "police stations").
        ...
        - **Examples (you MUST follow this format)**:
          ...
          * Without specific data (user asked for bars): "You can find nearby **bars** here: [Bars](url)."
          * Without specific data (user asked for police stations): "You can find nearby **police stations** here: [link(s)]."
...
def create_user_prompt(
    ...
    if has_amenity_links and amenity_links_list:
        ...
        amenity_note = f"\n\n🚨 IMPORTANT - AMENITY LINKS: You MUST include these clickable links in your response. \n\n**AVAILABLE LINKS (COPY THESE EXACTLY INTO YOUR RESPONSE):**\n{links_text}\n\n**MANDATORY INSTRUCTIONS:**\n- **ALWAYS include the above markdown links in your response text**\n- **When these links are provided, they ARE the answer** — do NOT start with \"I don't have specific information\" or \"the listing data doesn't contain\". Lead with the helpful link.\n- If you have specific amenity names/distances from the listing data, you may mention them first, then add: 'You can also explore these links: {links_text}'\n- If you do NOT have specific amenity names in the data, say directly: 'You can find nearby [amenity type, e.g. bars / police stations] here: {links_text}' — use the same wording as the user's question (e.g. \"bars\", \"police stations\") so the answer feels direct and helpful.\n- **Copy the markdown links EXACTLY as shown above (including the square brackets and parentheses)**\n- Examples:\n  * With specific data: 'According to the property information, nearby schools include **Boneo Primary School** (approximately **5.5 km** away). You can also explore these links: {links_text}'\n  * Without specific data (user asked for bars): 'You can find nearby **bars** here: {links_text}'\n  * Without specific data (user asked for police stations): 'You can find nearby **police stations** here: {links_text}'"
    elif has_amenity_links:
        amenity_note = "\n\n🚨 IMPORTANT - AMENITY LINKS: Google Maps links for the requested amenities will be provided below your response. \n\n**MANDATORY INSTRUCTIONS:**\n- When these links are provided, they ARE the answer — do NOT start with \"I don't have specific information\" or \"the listing data doesn't contain\". Lead with the helpful link.\n- If you mention specific amenities from the listing data (e.g., school names, hospital names), add: 'You can also use the link(s) below to find more amenities in the area for reference.'\n- If you do NOT mention specific amenities from the data, say directly: 'You can find nearby [amenity type from user's question, e.g. bars / police stations] using the link(s) provided below.'\n- Always use 'link' (singular) if only one link is provided, 'links' (plural) if multiple links are provided."
